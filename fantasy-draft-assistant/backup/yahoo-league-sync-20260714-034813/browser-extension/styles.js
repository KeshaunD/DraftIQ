...
/* ALWAYS-VISIBLE FAVORITES + ROSTER */
...
.dc-compact-label-icon,
.dc-mini-star {
  color: #F3B83F;
}

.dc-compact-label strong {
  min-width: 17px;
  height: 17px;
  display: inline-flex;
  align-items: center;
...
.dc-compact-items::-webkit-scrollbar {
  display: none;
}
...
.dc-mini-player:hover {
  border-color: rgba(243, 184, 63, 0.58);
  background: #172129;
  transform: translateY(-1px);
}

.dc-mini-player .dc-pos {
  padding: 2px 4px;
  font-size: 8px;
}
